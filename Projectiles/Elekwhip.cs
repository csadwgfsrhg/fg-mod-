...
{
    public class Elekwhip : ModProjectile
    {
     ...
     Projectile.WhipSettings.Segments = 7;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Elektric>(), 15);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Rectangle frame = new Rectangle(0, 0, 34, 28); // The size of the Handle (measured in pixels)
                ...
                if (i == list.Count - 2)
                {
                    ...
                    frame.Y = 48; // Distance from the top of the sprite to the start of the frame.
